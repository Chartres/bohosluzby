...
export const cs = {
  ...
  feedback_thanks: 'Díky, zpětnou vazbu jsme dostali. Opravu rozpisu předáváme farnosti a evidenci bohoslužeb.',
  feedback_cta: 'Našli jste chybu v rozpisu? Napište nám',
  feedback_intro: 'Co chybí? Co nesedí? Opravu rozpisu předáme farnosti a evidenci bohoslužeb, ostatní píšete přímo autorovi.',
...
export const en: Record<Key, string> = {
  ...
  feedback_thanks: 'Thanks, we got your feedback. Schedule corrections are forwarded to the parish and the service registry.',
  feedback_cta: 'Found a mistake in the schedule? Let us know',
  feedback_intro:
    "What's missing? What's wrong? A schedule correction goes to the parish and the service registry, anything else straight to the author.",
